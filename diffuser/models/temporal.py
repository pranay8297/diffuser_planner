...
class TemporalUnet(nn.Module):
    ...
    def __init__(
        ...
        self.time_mlp = nn.Sequential( # Timestep embeddings
        ...
        self.downs = nn.ModuleList([]) # Unet encoder
        self.ups = nn.ModuleList([]) # Unet decoder
        num_resolutions = len(in_out) # Shit
